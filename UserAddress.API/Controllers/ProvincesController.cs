...
namespace UserAddress.API.Controllers
{
    ...
    public class ProvincesController : ApiBaseController
    {
        ...
        public ProvincesController(IMediator mediator, ILoggingService logging)
        {
            _mediator = mediator;
            _logging = logging;
        }
        ...
        public async Task<IActionResult> Get()
        {
            try  
            { 
                return Ok(await _mediator.Send(new GetAllProvinceRecordQuery()));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Get(Guid id)
        {
            ...
            try
            {
                return Ok(await _mediator.Send(new GetProvinceRecordQuery(id)));
            }
            catch (Exception ex)
            {
                _logging.LogError(ex.ToString());
        ...
        //[HttpPut]
        //public async Task<IActionResult> Put(UpdateProvinceRecordCommand command)
        //{
        //    if (command == null)
        //    {
        //        return BadRequest("command is request.");
        ...
        //    try
        //    {
        //        //var deletedRecord = await _mediator.Send(new DeleteProvinceRecordCommand(id));
